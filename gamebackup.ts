...
a3.addComponent(new Transform({ position: new Vector3(156, 48, 16), scale: new Vector3(6, 6, 1), rotation: Quaternion.Euler(0, 90, 0) }));
...
a4.addComponent(new Transform({ position: new Vector3(6, 1, 11), scale: new Vector3(1, 1, 1), rotation: Quaternion.Euler(0, 0, 0) }));
a4.addComponent(
  new OnPointerDown(() => {
    unsub()
  inventoryContainer2.visible = true
...
a5.addComponent(new Transform({ position: new Vector3(8, 1, 11), scale: new Vector3(1, 1, 1), rotation: Quaternion.Euler(0, 0, 0) }));
a5.addComponent(
  new OnPointerDown(() => {
  unsub()
  inventoryContainer2.visible = true
...
a6.addComponent(new Transform({ position: new Vector3(10, 1, 11), scale: new Vector3(1, 1, 1), rotation: Quaternion.Euler(0, 0, 0) }));
a6.addComponent(
  new OnPointerDown(() => {
  unsub()
  inventoryContainer2.visible = true
