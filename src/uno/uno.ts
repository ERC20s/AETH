...
// import { userData, addBot, uno_bot } from './wsConnection'
...
export class UNO extends Entity {
  ...
  initTable() {
    ...
    this.table.addComponent(new Transform({ position: new Vector3(103, 0, 16) }))
  ...
  changeSkin(playing: boolean) {
    if (playing) this.table.addComponentOrReplace(new GLTFShape("models/tabledone.glb"))
    else this.table.addComponentOrReplace(new GLTFShape("models/table.glb"))
  }
